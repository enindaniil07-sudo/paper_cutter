...
$pageIds = @(0, 1, 2, 10, 11, 12, 13, 14, 15, 16)
...
& python (Join-Path $Repo "scripts\pack_dwin_set_screen_to_icl.py") --project $Root --icl-id 32 --bmps "00.bmp,01.bmp,02.bmp,10.bmp,11.bmp,12.bmp,13.bmp,14.bmp,15.bmp,16.bmp" --quality 92
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
