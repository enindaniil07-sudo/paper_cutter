...
Полный экран: ЗАДАНО / ОСТАЛОСЬ / прогресс / м/с / об/мин + СТАРТ / СБРОС / СТОП. Тап **ЗАДАНО** → стр. **10**. Реверс → стр. **11**.
...
| ИСПРАВИТЬ (стр. 11) | 6054 | BitButton — сброс ошибки реверса |
| Open keypad | 6053 | BitButton Pic_Next=10 |
| KB buffer | 6080 | ArtTextShow |
| Keys / OK / Cancel | 60A1–60AD | BitButton |

**Стр. 11** — «ОШИБКА ВРАЩЕНИЯ» (реверс энкодера). MCU переключает PIC_SET.
